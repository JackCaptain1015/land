...
@MapperScan(basePackages = "com.adbaitai.odps.mapper",sqlSessionTemplateRef = "odpsSqlSessionTemplate")
public class OdpsDataSourceConfig {

    public static final String ODPS_MAPPER_RESOURCE_LOCATION = "classpath:com/adbaitai/odps/mapper/*.xml";
